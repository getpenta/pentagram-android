...
public class LocaleController{
    ...
    public static String getString(String key, int res) {
        if(TextUtils.equals(key, "AppName") || TextUtils.equals(key, "AppNameBeta")) {
            return getInstance().getStringInternal("", res);
        } else {
            return getInstance().getStringInternal(key, res).replace("Telegram", "Pentagram");
        }
    }

    public static String getStringNoReplace(String key, int res) {
    ...
    public static String formatString(@StringRes int res, Object... args) {
        ...
        return formatString(key, res, args).replace("Telegram", "Pentagram");
    }

    public static String formatString(String key, int res, Object... args) {
        return formatString(key, null, res, 0, args).replace("Telegram", "Pentagram");
    }
